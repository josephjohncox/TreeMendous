"""Correctness-attested benchmark for warehouse bin range leasing."""
...
def run_benchmark(
    ...
    """Run a bounded deterministic bin lifecycle and attest all evidence."""
    ...
    engine = WarehouseBinPool({_SCOPE: BinZone(1, capacity)}, clock=clock)
    adapter = LeasingBenchmarkAdapter(
        scenario_id="warehouse-bin-ranges",
        ...
        snapshot_extra=warehouse_snapshot_extra,
        metadata_labels=("standard", "general"),
    )
