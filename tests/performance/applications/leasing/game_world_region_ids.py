"""Correctness-attested benchmark for game world region leasing."""
...
def run_benchmark(
    ...
    """Run a bounded deterministic region lifecycle and attest all evidence."""
    ...
    engine = GameRegionPool({_SCOPE: (1, capacity)}, clock=clock)
    adapter = LeasingBenchmarkAdapter(
        scenario_id="game-world-region-ids",
